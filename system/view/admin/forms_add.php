...
<div class="row-fluid">
  ...
  <div class="span10">
        <p><h2><?=empty($type) ? $this->p_lang['model'] : $this->p_lang['form']?><?=$this->p_lang['add']?>&nbsp;&nbsp;<a onClick="add()"><?=$this->p_lang['field'].$this->p_lang['add']?></a></h2></p><form action="" method="post">
          <table class="table">
  <tr>
    <td class="span2"><?=$this->p_lang['model'].$this->p_lang['name']?></td>
    <td class="span10"><input name="name" type="text" id="name" value="">
<?
 if($type == 1){
?>&nbsp;&nbsp;
<?=$this->p_lang['login'].$this->p_lang['type']?>:
  ...
  <table class="table table-bordered" id="tab"></table><table>
