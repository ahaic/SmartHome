...
<div class="row-fluid">
  ...
  <div class="span10">
        <p><h2><?=$this->p_lang['classify'].$this->p_lang['add']?></h2></p><form action="" method="post">
<table class="table">
<tr><td class="span2"><?=$this->p_lang['higher'].$this->p_lang['classify']?></td><td><?=$cate_str?>
 &nbsp;<input name="csort" type="text" value="1" style="width:15px;">&nbsp;<?=$this->p_lang['sort']?>&nbsp;&nbsp;
 <input name="con" type="checkbox" id="con" value="1" checked>&nbsp;<?=$this->p_lang['show']?>&nbsp;&nbsp;<input name="clinkture" type="checkbox" id="clinkture" onClick="on_link()" value="1">&nbsp;<?=$this->p_lang['outside']?>
  <label for="con"></label></td></tr>
<tr><td><?=$this->p_lang['classify'].$this->p_lang['name']?></td><td><input type="text" name="cname" id="cname"></td></tr>
  <tr class="out_link" style=" display: none"><td class="span2"><?=$this->p_lang['classify'].$this->p_lang['outlink']?></td><td><input type="text" name="clink" id="clink" value=""></td></tr>

<tr class="not_out_link"><td class="span2"><?=$this->p_lang['classify'].$this->p_lang['keyword']?></td><td><input type="text" name="ckeyword" id="ckeyword"></td></tr>
<tr class="not_out_link"><td><?=$this->p_lang['classify'].$this->p_lang['pic']?></td><td><input type="text" name="cimg" id="cimg">
...
<tr class="not_out_link"><td><?=$this->p_lang['classify'].$this->p_lang['template']?></td><td><input name="ctemp" type="text" id="ctemp" value="cate"></td></tr>
<tr class="not_out_link"><td><?=$this->p_lang['content'].$this->p_lang['template']?></td><td><input name="ntemp" type="text" id="ntemp" value="view" <?=$input_style?>></td></tr>
