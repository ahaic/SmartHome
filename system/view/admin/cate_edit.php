...
$c_field = unserialize($rs[0]['cfield']);
?>
<script>
var allPlugin={
...
<tr bgcolor="#f9f9f9"><td <?=$td_style?> width="110"><?=$this->p_lang['higher'].$this->p_lang['class']?></td><td  <?=$td_style?>><?=$cate_str?>
  <input name="con" type="checkbox" id="con" value="1" <? if($rs[0]['con'] == 1)echo 'checked';?>>&nbsp;<?=$this->p_lang['view']?>&nbsp;&nbsp;<input name="clinkture" type="checkbox" id="clinkture" onClick="on_link()" value="1" <? if($rs[0]['clinkture'] == 1)echo 'checked';?>>&nbsp;<?=$this->p_lang['outlink']?>&nbsp;&nbsp;<input name="csort" type="text" style="width:30px" value="<?=$rs[0]['csort']?>">&nbsp;<?=$this->p_lang['sort']?>
  <label for="con"></label></td></tr>
  

<tr bgcolor="#f9f9f9"><td <?=$td_style?> width="110"><?=$this->p_lang['class'].$this->p_lang['name']?></td><td  <?=$td_style?>><input type="text" name="cname" id="cname" <?=$input_style?> value="<?=$rs[0]['cname']?>"></td></tr></table>

<table class="table2" width="100%" border="0" cellspacing="0" id="out_link" <? if($rs[0]['clinkture'] == 0)echo 'style="display:none"';?>>
  <tr bgcolor="#f9f9f9"><td <?=$td_style?> width="110"><?=$this->p_lang['class'].$this->p_lang['outlink']?></td><td  <?=$td_style?>><input type="text" name="clink" id="clink" <?=$input_style?> value="<?=$rs[0]['clink']?>"></td></tr>
  </table>
<table class="table2" id="not_out_link" width="100%" border="0" cellspacing="0" <? if($rs[0]['clinkture'] == 1)echo 'style="display:none"';?>>
<tr bgcolor="#f9f9f9"><td <?=$td_style?> width="110"><?=$this->p_lang['class'].$this->p_lang['keyword']?></td><td  <?=$td_style?>><input type="text" name="ckeyword" id="ckeyword" <?=$input_style?> value="<?=$rs[0]['ckeyword']?>"></td></tr>
<tr bgcolor="#f9f9f9"><td <?=$td_style?> width="110"><?=$this->p_lang['class'].$this->p_lang['pic']?></td><td  <?=$td_style?>><input type="text" name="cimg" id="cimg" <?=$input_style?> value="<?=$rs[0]['cimg']?>">
...
<tr bgcolor="#f9f9f9"><td <?=$td_style?> width="110"><?=$this->p_lang['class'].$this->p_lang['temp']?></td><td  <?=$td_style?>><input type="text" name="ctemp" id="ctemp" <?=$input_style?> value="<?=$rs[0]['ctemp']?>"></td></tr>
<tr bgcolor="#f9f9f9"><td <?=$td_style?> width="110"><?=$this->p_lang['content'].$this->p_lang['temp']?></td><td  <?=$td_style?>><input type="text" name="ntemp" id="ntemp" <?=$input_style?> value="<?=$rs[0]['ntemp']?>"></td></tr>
...
<tr bgcolor="#f9f9f9"><td <?=$td_style?> width="110"><?=$this->p_lang['class'].$this->p_lang['content']?></td><td  <?=$td_style?>><textarea name="cinfo" id="cinfo" style="width:600px; height:400px" onBlur="this.className='kuang'" class="xheditor {skin:'nostyle', plugins:allPlugin, loadCSS:'<style>pre{margin-left:2em;border-left:3px solid #CCC;padding:0 1em;}</style>',forcePtag:false, <?=$editor?>}"><?=$rs[0]['cinfo']?></textarea></td></tr></table>
<table class="table2" width="100%" border="0" cellspacing="0">
<tr bgcolor="#f9f9f9">
  <td  <?=$td_style?> align="center"><input type="submit" value="<?=$this->p_lang['submit']?>" style="border:1px #000000 solid;vertical-align:middle;height:25px"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
